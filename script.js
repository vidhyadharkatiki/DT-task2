...
let toogle = true;
let val = document.querySelector('.left');
document.querySelector('#ficon').addEventListener('click', function() {
    if(toogle === true){
        val.style.animation = 'slide 2s forwards';
        toogle = false; 
        ele.style.display = 'block';
    }
    else{
        val.style.animation = 'slideback 2s forwards';
            toogle = true;
            ele.style.display = 'none';
        }
});
document.querySelector("#explore").textContent = Data.tasks[0].task_title;
document.querySelector("#explorein").textContent = Data.tasks[0].task_description;
document.querySelector(".tech").textContent = Data.tasks[0].assets[0].asset_title;
document.querySelector(".buildtech").textContent = "Description: "+Data.tasks[0].assets[0].asset_description;
document.querySelector(".builder").textContent = Data.tasks[0].assets[1].asset_title;
document.querySelector(".buildbuilder").textContent = "Description: "+Data.tasks[0].assets[1].asset_description;
document.querySelector(".structure").textContent = Data.tasks[0].assets[2].asset_title;
document.querySelector(".pointer").textContent = "Description: "+Data.tasks[0].assets[2].asset_description;
document.querySelector(".model").textContent = Data.tasks[0].assets[3].asset_title;
document.querySelector(".buildmodel").textContent = "Description: "+Data.tasks[0].assets[3].asset_description;
